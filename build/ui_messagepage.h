...
public:
    ...
    {
        MessagePage->setWindowTitle(QApplication::translate("MessagePage", "Address Book", nullptr));
        labelExplanation->setText(QApplication::translate("MessagePage", "These are your sent and received encrypted messages. Click on an item to read it.", nullptr));
#ifndef QT_NO_TOOLTIP
        tableView->setToolTip(QApplication::translate("MessagePage", "Click on a message to view it", nullptr));
#endif // QT_NO_TOOLTIP
        messageDetails->setTitle(QString());
        backButton->setText(QApplication::translate("MessagePage", "&Back", nullptr));
        labelContact->setText(QApplication::translate("MessagePage", "Contact:", nullptr));
        contactLabel->setText(QString());
        newButton->setText(QApplication::translate("MessagePage", "&Conversation", nullptr));
#ifndef QT_NO_TOOLTIP
        sendButton->setToolTip(QApplication::translate("MessagePage", "Sign a message to prove you own a Advantage address", nullptr));
#endif // QT_NO_TOOLTIP
        sendButton->setText(QApplication::translate("MessagePage", "&Send", nullptr));
#ifndef QT_NO_TOOLTIP
        copyFromAddressButton->setToolTip(QApplication::translate("MessagePage", "Copy the currently selected address to the system clipboard", nullptr));
#endif // QT_NO_TOOLTIP
        copyFromAddressButton->setText(QApplication::translate("MessagePage", "&Copy From Address", nullptr));
#ifndef QT_NO_TOOLTIP
        copyToAddressButton->setToolTip(QApplication::translate("MessagePage", "Copy the currently selected address to the system clipboard", nullptr));
#endif // QT_NO_TOOLTIP
        copyToAddressButton->setText(QApplication::translate("MessagePage", "Copy To &Address", nullptr));
#ifndef QT_NO_TOOLTIP
        deleteButton->setToolTip(QApplication::translate("MessagePage", "Delete the currently selected address from the list", nullptr));
#endif // QT_NO_TOOLTIP
        deleteButton->setText(QApplication::translate("MessagePage", "&Delete", nullptr));
    } // retranslateUi
