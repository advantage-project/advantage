...
public:
    ...
    {
        AddEditAdrenalineNode->setWindowTitle(QApplication::translate("AddEditAdrenalineNode", "Add/Edit Advantage Node", nullptr));
        label_9->setText(QApplication::translate("AddEditAdrenalineNode", "<html><head/><body><p>Enter a friendly nickname for your Masternode and its respective address IP and port: 53211. The address should be in the format 123.456.789.123:53211. You must send exactly 1,000,000 USDA to your collateral address.</p></body></html>", nullptr));
        ...
        label_3->setText(QApplication::translate("AddEditAdrenalineNode", "Reward Address", nullptr));
        label_7->setText(QApplication::translate("AddEditAdrenalineNode", "Reward %", nullptr));
