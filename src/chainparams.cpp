...
public:
    CMainParams() {
		...
		treasuryAddress = "AZunow8bT6b4ganZFk1nrYZC5Pn631qq4z"; //update accordingly
	...
	vSeeds.push_back(CDNSSeedData("1", "45.63.21.23")); //update permanent seednode
        nPoolMaxTransactions = 3;

        strDarksendPoolDummyAddress = "AHhWC9PRgMzm6z5Xx3zjCSTG5zJ5u71UbL"; //irrelevant
        nLastPOWBlock = 101; //update accordingly
        nPOSStartBlock = 2;
    }
